...
int main() {
    ...
    wait(1);
    send_command_to_tmux("MASTER2", "./tsd -c 2 -s 1 -k 9090 -p 20000");

    create_tmux_session("MASTER3");
    wait(1);
    send_command_to_tmux("MASTER3", "./tsd -c 3 -s 1 -k 9090 -p 30000");

    // Start 3 Slave Servers
    create_tmux_session("SLAVE1");
    wait(1);
    send_command_to_tmux("SLAVE1", "./tsd -c 1 -s 2 -k 9090 -p 10001");

    create_tmux_session("SLAVE2");
    wait(1);
    send_command_to_tmux("SLAVE2", "./tsd -c 2 -s 2 -k 9090 -p 20001");

    create_tmux_session("SLAVE3");
    wait(1);
    send_command_to_tmux("SLAVE3", "./tsd -c 3 -s 2 -k 9090 -p 30001");
